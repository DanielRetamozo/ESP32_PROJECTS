...
//Configura el pin 2 (led interno) como salida.
  pinMode(2,OUTPUT);
//Manda un valor bajo al pin 2 (led interno) y se apaga el led.
  digitalWrite(2,LOW);
}
...
//Si encuentra el caracter "a" se cumple la condicional if y pasa a la sigueinte linea.
    if (SerialBT.read()=='a'){
//Manda un valor alto al pin 2 (led interno) y se enciende el led.
    digitalWrite(2,HIGH);
//Imprime en el Monitor Serial.
